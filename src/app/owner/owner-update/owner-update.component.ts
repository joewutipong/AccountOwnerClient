...
export class OwnerUpdateComponent implements OnInit {
  ...
  constructor(private repository: OwnerRepositoryService, private errorHandler: ErrorHandlerService, 
    private router: Router, private activeRoute: ActivatedRoute, private datePipe: DatePipe, private modal: BsModalService) { }
  ...
  private getOwnerById = () => {
    ...
    const ownerByIdUri: string = `api/owners/${ownerId}`;
  ...
  private executeOwnerUpdate = (ownerFormValue) => {
    ...
    const apiUrl: string = `api/owners/${this.owner.id}`;
